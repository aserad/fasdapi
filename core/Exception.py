...
async def db_validation_error(_: Request, exc: ValidationError):
    """
    数据库字段验证错误
    :param _:
    :param exc:
...
async def db_integrity_error(_: Request, exc: IntegrityError):
    """
    完整性错误
    :param _:
    :param exc:
...
async def db_does_not_exist(_: Request, exc: DoesNotExist):
    """
    mysql 查询对象不存在异常处理
    :param _:
    :param exc:
...
async def db_operational_error(_: Request, exc: OperationalError):
    """
    mysql 数据库异常错误处理
    :param _:
    :param exc:
